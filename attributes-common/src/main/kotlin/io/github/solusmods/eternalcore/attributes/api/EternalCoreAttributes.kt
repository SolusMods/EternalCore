...
object EternalCoreAttributes {
     ...
     */
    @JvmField
    val CRITICAL_ATTACK_CHANCE: Holder<Attribute?> = EternalCoreAttributeRegister.registerGenericAttribute(
        ModuleConstants.MOD_ID,
        "critical_attack_chance", "eternalcore.attribute.critical_attack_chance",
        0.0, 0.0, 100.0, true, Attribute.Sentiment.POSITIVE
    )
     ...
     */
    @JvmField
    val GLIDE_SPEED_MULTIPLIER: Holder<Attribute?> = EternalCoreAttributeRegister.registerPlayerAttribute(
        ModuleConstants.MOD_ID,
        "glide_speed_multiplier", "eternalcore.attribute.glide_speed_multiplier",
        0.0, 0.0, 1024.0, true, Attribute.Sentiment.POSITIVE
    )
     ...
     */
    @JvmField
    val LAVA_SPEED_MULTIPLIER: Holder<Attribute?> = EternalCoreAttributeRegister.registerGenericAttribute(
        ModuleConstants.MOD_ID,
        "lava_speed_multiplier", "manascore.attribute.lava_speed_multiplier",
        1.0, 0.0, 1024.0, true, Attribute.Sentiment.POSITIVE
    )
     ...
     */
    @JvmField
    val SWIM_SPEED_MULTIPLIER: Holder<Attribute?> = EternalCoreAttributeRegister.registerGenericAttribute(
        ModuleConstants.MOD_ID,
    ...
    @JvmStatic
    fun getResourceKey(modID: String, path: String): ResourceKey<Attribute?> {
